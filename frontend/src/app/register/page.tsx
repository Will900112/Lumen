...
import { login, register, googleAuthorize,  getToken } from "@/lib/api";
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (e.message?.includes("ALREADY_EXISTS")) {
                ...
                setError("Password too weak. Please use a stronger one.");
            } else {
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-base text-stone-600 mb-3">
                        Your evidence-based wellness stack awaits.
                    </p>
